package com.print.printlib.print;
...
import com.print.printlib.bt.BtService;
    ...
    public synchronized void print() {
        try {
            ...
            if (mBtService.getState() != BtService.STATE_CONNECTED) {
                if (!TextUtils.isEmpty(PrintPlan.btAddress)) {
                    BluetoothDevice device = mAdapter.getRemoteDevice(PrintPlan.btAddress);
